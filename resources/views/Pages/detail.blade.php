                        ...
                        <div class="col l-12 m-12 c-12">
                            <div class="main" id="main">
                                <form method="POST" class="form" id="form-infor">
                                    ...
                                    <p class="">
                                        <strong>Lưu ý: </strong>Hủy sân trước <span style="color: red">1 tiếng thời gian bắt đầu</span> hoàn tiền lại 100% vào số dư tài khoản của bạn trên website. Trước nữa tiếng hoàn lại 50%. Sau <span style="color: red">nữa tiếng</span> không thể hủy sân.
                                    </p>
                                </form>
                            </div>
                        </div>
